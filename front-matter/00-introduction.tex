...
la velocità del vento e ulteriori parametri di rilievo. Tuttavia, per far sì che tale sforzo tecnologico si traduca in un impatto reale sul territorio, 
è fondamentale affiancare alla raccolta dati il coinvolgimento attivo della collettività. 
Promuovere l'ecoturismo e incentivare comportamenti consapevoli tra cittadini e visitatori diventa quindi un passo 
imprescindibile per trasformare la consapevolezza in azione concreta.

È proprio da questa necessità di unire tutela ambientale e partecipazione attiva che nasce \textit{EcoSpot}, un'applicazione 
mobile sviluppata all'interno del progetto DISCOV.ER.
L'obiettivo centrale dell'applicativo è proporsi come piattaforma educativa capace di trasformare la visita al Parco in un'esperienza 
interattiva di salvaguardia. Per raggiungere questo scopo, EcoSpot oltre alla tradizionale funzione di guida turistica integra meccaniche 
di gamification e sfide studiate per incentivare un'esplorazione responsabile del territorio. 
Attraverso il completamento delle attività proposte, il visitatore viene coinvolto in prima persona, sviluppando un forte legame con 
l'ecosistema e una maggiore propensione alla sua tutela.

A supporto di questo, l'applicazione agisce anche come interfaccia per il monitoraggio di DISCOV.ER. La disponibilità della vasta mole di dati ambientali 
richiede infatti strumenti digitali adeguati affinché possa essere resa facilmente consultabile dal grande pubblico. 
EcoSpot offre la possibilità di visionare le metriche dei sensori \ac{IoT} sulla mappa in modo chiaro e di immediata comprensione. 
Dati fisicamente invisibili ma ecologicamente significativi, come quelli relativi all'intrusione del cuneo salino, vengono così resi tangibili. 
Rendendo visibile l'impatto dei cambiamenti climatici sugli habitat, l'app informa l'utente e connette in modo bidirezionale la realtà 
fisica del Parco alla sua rappresentazione digitale.
