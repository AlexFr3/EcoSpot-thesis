...
\begin{itemize}
    \item \textbf{Esplorazione Geografica:} Il sistema deve fornire una mappa interattiva del Delta del Po che visualizzi in tempo reale la posizione GPS dell'utente, le aree di interesse naturalistico (flora e fauna) e le stazioni di monitoraggio ambientale. 
