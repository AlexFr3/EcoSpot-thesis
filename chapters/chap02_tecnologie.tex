...
Per fornire contesto meteorologico ai POI, viene utilizzata l'API open-source Open-Meteo \cite{open_meteo_api}, che fornisce dati su temperatura e condizioni del cielo basati sulle coordinate GPS.
