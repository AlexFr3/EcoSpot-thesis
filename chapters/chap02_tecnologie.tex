...
\begin{enumerate}
    ...
    testuale, la posizione GPS esatta (\textit{GeoPoint}) e il timestamp di creazione. Le prove fotografiche devono essere 
...
una tonalità di verde desaturato, si ispira all'identità visiva del progetto \textit{DISCOV.ER} (Digital Twin and Citizen Science for the Sustainability of Areas of Natural and Tourist Interest)
...
\subsection{Architettura del Database: Cloud Firestore} Al fine di soddisfare i requisiti di scalabilità e sincronizzazione in tempo reale, 
il sistema si avvale di un database NoSQL organizzato in Collezioni di Documenti JSON-like. 
