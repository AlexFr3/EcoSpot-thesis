...
\begin{itemize}
    ...
    \item \textbf{Catalogo delle Specie e degli Habitat:} 
    Questa entità funge da base di conoscenza. Il requisito principale è associare ogni specie a vincoli spaziali precisi. Il modello include le coordinate degli habitat e le soglie di distanza necessarie per abilitare la logica di \textit{geofencing}: il contenuto è sempre accessibile, ma soltanto quando vengono soddisfatti i requisiti di prossimità fisica l'habitat viene classificato come scoperto.
