...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../figures/green_area/MappaDeltaDelPo.png}
    \caption[Le Stazioni del Parco]{Le Stazioni del Parco. \textit{Fonte: Archivio Parco Delta del Po Emilia-Romagna.}}
    \label{fig:stazioni_parco}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/green_area/Pineta_di_Classe.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/green_area/Lido_di_Spina.jpg}
...
\subsection{Biodiversità, pressioni antropiche e  turismo}
...
\subsubsection{Flora e fauna caratteristica}
La vegetazione del delta è dominata da flora tipica degli ambienti salmastri, adattate a condizioni di stress salino estremo tipiche degli 
ambienti di transizione tra acqua dolce e marina. Oltre alle salicornie, l'ecosistema lagunare ospita specie come \textit{Limonium serotinum}, 
\textit{Inula crithmoides} e \textit{Juncus maritimus}, che formano successioni vegetazionali lungo gradienti di idroperiodo e salinità \cite{scienza_della_vegetazione}.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/animals/pink_flamingo.jpg} 
...
\end{figure}
\clearpage
\subsubsection{Evoluzione dell'offerta turistica}
...
\subsection{Il progetto DISCOV.ER ed EcoSpot}
...
Il progetto propone un approccio innovativo per la gestione e la valorizzazione delle aree di interesse naturale e turistico, adottando come caso di studio l'ecosistema complesso del Parco del Delta del Po \cite{2025discover}.
...
Proprio in questo contesto teorico e territoriale si inserisce \textbf{EcoSpot}, colmando il vuoto funzionale esistente tra la ricerca accademica e la fruizione turistica. L'applicazione propone un modello ibrido che unisce l'immediatezza di consultazione delle guide turistiche tradizionali, il rigore della \textit{Citizen Science} e l'accessibilità in tempo reale ai dati di monitoraggio.

EcoSpot si configura dunque come una guida digitale interattiva per l'esplorazione e la valorizzazione dell'ecosistema del Delta del Po, con una particolare attenzione alle Valli di Comacchio e alle aree frequentate dal fenicottero rosa.
L'obiettivo principale è supportare un modello di \textit{Ecoturismo avanzato}, coniugando scoperta naturalistica, monitoraggio ambientale e meccaniche ludiche 
orientate all'educazione ecologica \cite{turismo_deltadelpo}. 

L'applicazione aspira ad accompagnare l'utente nella scoperta fisica del territorio, permettendogli di esplorare habitat, conoscere specie e comprendere lo stato di salute dell'ecosistema attraverso un'interfaccia unificata. EcoSpot è pensata per un pubblico eterogeneo  turisti, famiglie, scuole e appassionati di \textit{birdwatching} che desidera un'esperienza immersiva, consapevole e informata nel cuore del Delta del Po.