...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/app_img/layers.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/app_img/statistics.png}
...
\end{minted}
\caption{Parsing e normalizzazione dei dati JSON dai sensori IoT}
